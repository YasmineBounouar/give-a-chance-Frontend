  ...
  return (
     <div className={styles.card}>
        ...
        <div className={styles.cardImage}>
           ...
           <Link href='/'><span className={styles.iconpartage}><FontAwesomeIcon icon={faShareNodes} className={styles.shareIconStyle}/></span></Link> 
           {/* J'ai rajouter l'icone pour le partage et le like, il faut changer le className de Incone de partage. */}
            <span className={styles.iconlike}><FontAwesomeIcon icon={faHeart} className={styles.heartIconStyle}/></span>
        </div>
        ...
        <div className={styles.cardDescription}>
            ...
            <div className={styles.locationcard}>
                    <span><FontAwesomeIcon icon={faLocationDot} className={styles.LocationIconStyle}/></span>
        ...
        <div className={styles.cardRating}>
            ...
            <span><FontAwesomeIcon icon={faStar} className={styles.starsIconStyle}/></span>
            <span><FontAwesomeIcon icon={faStar} className={styles.starsIconStyle}/></span>
            <span><FontAwesomeIcon icon={faStar} className={styles.starsIconStyle}/></span>
            <span><FontAwesomeIcon icon={faStar} className={styles.starsIconStyle}/></span>
            <span><FontAwesomeIcon icon={faStar} className={styles.starsIconStyle}/></span>
